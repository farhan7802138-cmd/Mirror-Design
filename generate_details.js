  ...
  <header class="site-header" id="site-header">
    <div class="container header-inner">
      ...
      <nav class="main-nav" id="main-nav">
        <a href="/#home">Home</a>
        <a href="/#aluminium-work" class="${product.category === 'aluminium' ? 'active' : ''}">Aluminium Work</a>
        <a href="/#mirrors-glass" class="${product.category !== 'aluminium' ? 'active' : ''}">Mirrors & Glass</a>
